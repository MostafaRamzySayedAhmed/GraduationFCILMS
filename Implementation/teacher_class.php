						<ul	 id="da-thumbs" class="da-thumbs">
										...
										?>
											<li id="del<?php echo $id; ?>">
												<a href="my_students.php<?php echo '?id='.$id; ?>">
														<img src ="<?php echo $row['image_class'] ?>" width="124" height="140" class="img-polaroid" alt="">
													<div>
									...
									<?php } }else{ ?>
									<div class="alert alert-info"><i class="icon-info-sign"></i> No Group Currently Added</div>
									<?php  } ?>
									</ul>