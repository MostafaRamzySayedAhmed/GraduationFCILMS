                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-right">
									<?php $query = mysql_query("select * from teacher_class_student
														...
														where student_id = '$session_id' and educational_year = '$educational_year'
														")or die(mysql_error());
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<?php }}else{ ?>
									<div class="alert alert-info"><i class="icon-info-sign"></i> You Are Currently Not Enroll To Any Groups</div>
									<?php } ?>	
									</ul>
