...
<?php $get_id = $_GET['id']; ?>
					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php }}else{ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i> No Posts Found</div>
								<?php } ?>
                                </div>
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			$('#'+id).modal('hide');
			$.jGrowl("Your Post is Successfully Deleted", { header: 'Post Delete' });
