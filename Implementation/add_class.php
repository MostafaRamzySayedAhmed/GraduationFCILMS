                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="icon-plus-sign"></i> Add Group</h4></div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form method="post" id="add_class">
										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
											<?php
											$query = mysql_query("select * from educational_year order by educational_year DESC");
											$row = mysql_fetch_array($query);
											?>
											<input id="" class="span5" type="text" class="" name="educational_year" value="<?php  echo $row['educational_year']; ?>" >
                                          </div>
                                        </div>
											<div class="control-group">
                                          <div class="controls">
			...
			jQuery(document).ready(function($){
				$("#add_class").submit(function(e){
					...
					$.ajax({
						...
						if(html=="true")
						{
						$.jGrowl("Group Already Exist", { header: 'Add Group Failed' });
						}else{
							$.jGrowl("Group Successfully  Added", { header: 'Group Added' });
							var delay = 500;
