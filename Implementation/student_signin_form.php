			...
			jQuery("#signin_student").submit(function(e){
					...
					$.ajax({
						...
						if(html=='true')
						{
						$.jGrowl("Welcome To FCI Learning Management System", { header: 'Sign Up Successeded' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'dashboard_student.php'  }, delay);  
						}else if(html=='false'){
							$.jGrowl("Student Does Not Found In The Database Please Make Sure To Check Your ID Number or Firstname, Lastname and The Section You Belong. ", { header: 'Sign Up Failed' });
						}
						}
