   <div class="row-fluid">
					    ...
					    <?php
                            if (isset($_POST['save'])) {
                                ...
                                mysql_query("insert into teacher (firstname,lastname,location,username,department_id)
								values ('$firstname','$lastname','uploads/NO-IMAGE-AVAILABLE.jpg','$username','$department_id')         
								") or die(mysql_error()); 
									
								mysql_query("insert into activity_log (date,username,action) values(NOW(),'$user_username','Add Lecturer $firstname $lastname')")or die(mysql_error());
                                ?>
								<script>
