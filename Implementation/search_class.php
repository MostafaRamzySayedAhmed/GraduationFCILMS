                ...
                <div class="span6" id="content">
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
						<?php
						$sy = $_POST['educational_year'];
						
						$educational_year_query = mysql_query("select * from educational_year where  educational_year = '$sy'")or die(mysql_error());
						...
						?>
							...
							<li><a href="#"><?php echo $educational_year_query_row['educational_year']; ?></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										where teacher_id = '$session_id' and educational_year = '$educational_year' ")or die(mysql_error());
										...
										?>
											<li>
												<a href="my_students.php<?php echo '?id='.$id; ?>">
														<img src ="<?php echo $row['image_class'] ?>" width="124" height="140" class="img-polaroid">
													<div>
													<span>
